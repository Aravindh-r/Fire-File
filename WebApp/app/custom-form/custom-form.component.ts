...
getTemplateStateData(state :string){
  ...
  this.stateValue=this.state[0]._value;
  console.log(this.state[0]._value);
  console.log(this.stateValue);
  this.customformService.getTemplateStateData(this.stateValue).subscribe((tempateStateData)=>{
      this.resultTemplateStateData =tempateStateData;
      console.log(tempateStateData);
      console.log(this.resultTemplateStateData);
    });
}
